...
def test_create_exercise():
    ...
    created_exercise = client.post(
        'http://localhost:8000/exercises', json=new_exercise).json()
...
def test_get_exercise():
    ...
    exercise = client.get(
        f'http://localhost:8000/exercises/{exercise_id}').json()
...
def test_update_exercise():
    ...
    client.patch(
        f'http://localhost:8000/exercises/{exercise_id}', json=body).json()
...
def test_delete_exercise():
    ...
    while exercise_ids:
        ...
        remaining_exercise_ids = {ex['id'] for ex in client.get(
            'http://localhost:8000/exercises').json()}
